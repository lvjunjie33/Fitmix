    ...
    <div>
        <div style="margin: 20px 20px 5px 20px;">
            <form action="/activity/save-activity-sign-up.json" method="post" isform>
                ...
                <c:if test="${signUpMode15 == 1 or signUpMode16 == 1}">
                    <div class="form-group">
                        <strong>团队信息</strong>
                    </div>
                    <c:if test="${signUpMode15 == 1}">
                        <div class="form-group">
                            <input class="form-control" type="text" name="userTeamName" maxlength="20" placeholder="团队名称" notnull=""  value="">
                        </div>
                    </c:if>
                    <c:if test="${signUpMode16 == 1}">
                        <div class="form-group">
                            <textarea class="form-control" type="text" name="userTeamSlogan" maxlength="3" placeholder="团队口号"></textarea>
                        </div>
                    </c:if>
                </c:if>
