...
<section id="wrapper">
    <section id="copy">
        ...
        <h1>${chatInfo.inviteNickName}</h1>
        <p>邀请你加入</p>
        <h1>`${chatInfo.chatName}` 群聊</h1>
        <a class="signup" href="javascript:" onclick="linktoHuman()">加入群聊</a>
        <div class="nohuman">
...
<div id="footer-down">
    ...
    <div style="display: inline-block;min-height: 50px;!important;position: absolute;top: 9px;padding-left: 8px;">
        ...
        <label style="font-size: 60%;">下载 APP 即可加入群聊</label>
    </div>
...
<script>
    ...
    function linktoHuman() {
        /*var openApp = "FITMIX://club-member/add.json?chatName=${chatInfo.chatName}&clubName=${club.name}";
