...
<link rel="stylesheet" href="/static/uikit/css/components/accordion.min.css">
    ...
    --%>
    <%-- 自动完成 autocomplete end--%>
    <%-- 日期选择器 datepicker start--%>
    ...
    --%>
    <%-- 高级表单 form-advanced end--%>
    <%-- 文件表单 form-file start--%>
    <%--
    ...
    --%>
    <%-- 密码表单 form-password end--%>
    <%-- 选择表单 form-select start--%>
    <%--
    ...
    --%>
    <%-- 选择表单 form-select end--%>
    <%-- html编辑器 htmleditor start--%>
    ...
    <link rel="stylesheet" href="/static/run-plan/css/run-plan-training.css">
...
<%--    <link rel="stylesheet" href="/static/bootstrap/bootstrap.min.css">--%>
    ...
    <script type="text/javascript" src="/static/run-plan/js/run-plan-training.js"></script>

<%--    <script src="/static/bootstrap/bootstrap.min.js"></script>

    <script src="/static/stickUp/stickUp.min.js"></script>--%>
