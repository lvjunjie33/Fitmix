package com.business.app.easeMob.comm.invoker;
...
import com.business.app.easeMob.comm.MessageTemplate;
import com.business.app.easeMob.comm.body.EmptyBody;
import com.business.app.easeMob.comm.constant.HTTPMethod;
import com.business.app.easeMob.comm.utils.RestAPIUtils;
...
import com.business.app.easeMob.api.RestAPIInvoker;
...
public class HttpClientRestAPIInvoker implements RestAPIInvoker {
	...
	public ResponseWrapper sendRequest(String method, String url, HeaderWrapper header, BodyWrapper body, QueryWrapper query) {
        ...
        if( null != body && null != body.getBody() && body.getBody().get(EmptyBody.EMPTY) == null){
