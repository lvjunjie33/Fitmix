...
import com.business.app.easeMob.api.ChatGroupAPI;
import com.business.app.easeMob.api.EasemobRestAPI;
import com.business.app.easeMob.comm.body.EmptyBody;
...
public class EasemobChatGroup extends EasemobRestAPI implements ChatGroupAPI {
    ...
    public Object getChatGroupDetails(String[] groupIds) {
        ...
        return getInvoker().sendRequest(HTTPMethod.METHOD_GET, url, header, new EmptyBody(), null);
    }
    ...
    public Object deleteChatGroup(String groupId) {
        ...
        return getInvoker().sendRequest(HTTPMethod.METHOD_DELETE, url, header, new EmptyBody(), null);
    }
    ...
    public Object addSingleUserToChatGroup(String groupId, String userId) {
        ...
        return getInvoker().sendRequest(HTTPMethod.METHOD_POST, url, header, new EmptyBody(), null);
    }
