 ...
 */
(function (g) {
    g.extend(!0, g.fn.zTree._z, {view: {clearOldFirstNode: function (c, a) {
        ...
        if (a && a.length != 0) {
            ...
            for (var j in d)a = d[j][c.data.key.children], f.setFirstNodeForShow(c, a), f.setLastNodeForShow(c, a)
        }
        ...
        if (a && a.length != 0) {
            ...
            for (var j in d)a = d[j][c.data.key.children], f.setFirstNodeForHide(c, a), f.setLastNodeForHide(c, a)
        }
        ...
        var b, d, i, e, h;
        for (d = 0, i = a.length; d < i; d++)if (b = a[d], !e && !b.isHidden &&
            b.isFirstNode) {
            e = b;
            break
        ...
        var b, d, e, g;
        for (d = a.length - 1; d >= 0; d--)if (b = a[d], !e && !b.isHidden &&
            b.isLastNode) {
            e = b;
            break
    ...
    e.addZTreeTools(function (c, a) {
        ...
        var b = a.checkNode;
        if (b)a.checkNode = function (c, e, f, h) {
    ...
    var o = e.makeChkFlag;
    if (o)e.makeChkFlag = function (c, a) {
    ...
    if (r)f.expandCollapseSonNode = function (c, a, b, d, e) {
        (!a || !a.isHidden) && r.apply(f, arguments)
    };
    var s = f.setSonNodeCheckBox;
    if (s)f.setSonNodeCheckBox = function (c, a, b, d) {
        (!a || !a.isHidden) && s.apply(f, arguments)
    };
    var t = f.repairParentChkClassWithSelf;
    if (t)f.repairParentChkClassWithSelf = function (c, a) {
