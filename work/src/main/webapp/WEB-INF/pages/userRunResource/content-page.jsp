...
<div class="uk-form-row">
    <ul class="uk-tab">
        <li class="uk-active"><a href="/user-run-share-resource/page/content.htm">内容</a></li>
        <li><a href="/user-run-share-resource/page/image.htm">图片</a></li>
    </ul>
</div>
        ...
        <c:forEach var="item" items="${page.result}">
            <tr>
                ...
                <td>
                    ...
                    <a href="javascript:" content-modify>修改</a>
                </td>
            </tr>
        </c:forEach>
    </tbody>
...
<%--分页条--%>
<lch:page page="${page}" href="/user-run-share-resource/page/content.htm"></lch:page>

<jsp:include page="content-add.jsp"/>
<jsp:include page="content-modify.jsp"/>
