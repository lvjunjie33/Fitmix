...
<div class="uk-container-center uk-body">
    <h2>添加产品信息</h2>
    <form action="/shop/product/product-add.json" method="post" class="uk-form  uk-form-horizontal" enctype="multipart/form-data" product-add-form>
        <div class="<%--uk-container--%>">
            ...
            <div class="uk-form-row">
                ...
                <div class="uk-form-controls">
                    <input type="text" name="coin" class="uk-form-large uk-width-9-10" notnull>
                </div>
            </div>
            ...
            <div class="uk-form-row">
                ...
                <div class="uk-form-controls">
                    <input type="text" name="quantity" class="uk-form-large uk-width-9-10" notnull>
                </div>
            </div>
