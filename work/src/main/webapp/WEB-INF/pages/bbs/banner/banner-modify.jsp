...
<%--<div class="uk-modal uk-open" id="mixBannerModfy">--%>
    <%--<div class="uk-modal-dialog">--%>
        ...
        <div class="uk-form-row">
            <form action="/bbs/banner/banner-modify.json" method="post" enctype="multipart/form-data" class="uk-form uk-form-horizontal" isform>
                <div class="uk-form-row">
                ...
                <div class="uk-form-row">
                    ...
                    <div class="uk-form-controls">
                        <textarea name="desc" class="uk-width-1-1 uk-form-large" placeholder="描述">${banner.desc}</textarea>
                    </div>
                </div>
