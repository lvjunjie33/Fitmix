...
<div id="file-add" class="uk-modal uk-open">
    <div class="uk-modal-dialog">
        ...
        <div class="uk-form-row">
            <form action="/handset/add.json" method="post" class="uk-form" id="file-add-form" isform>
                <div class="uk-form-row">
                ...
                <div class="uk-form-row">
                    <input class="uk-width-1-1 uk-form-large" type="text" name="other[number]" placeholder="序号" notnull>
                </div>
                <div class="uk-form-row">
