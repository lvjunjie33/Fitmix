...
<div id="activity-list">
    <div class="uk-form-row" style="padding-bottom: 20px">
        <form action="/log/stat/user/link.htm" method="post" class="uk-form">
            <div class="uk-form-row">
                ...
                <label>link：</label>
                <label><input type="number" name="uid" value="${uid}" placeholder="uid"></label>
    ...
    <div class="uk-overflow-container">
        <table class="uk-table uk-table-striped uk-text-nowrap uk-table-striped uk-table uk-table-hover">
            <thead>
            <tr><th colspan="2">用户编号：<a href="/user/user-info.htm?uid=${uid}" target="_blank">${uid}</a></th></tr>
            <tr>
