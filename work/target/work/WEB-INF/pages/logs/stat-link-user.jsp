...
<div id="activity-list">
    <div class="uk-form-row" style="padding-bottom: 20px">
        <form action="/log/stat/link/user.htm" method="get" class="uk-form">
            <div class="uk-form-row">
                ...
                <label>link：</label>
                <label><input type="text" name="link" value="${link}" placeholder="xxx.json"></label>
    ...
    <div class="uk-overflow-container">
        <table class="uk-table uk-table-striped uk-text-nowrap uk-table-striped uk-table uk-table-hover">
            <thead>
                <tr><th colspan="2">访问的地址：${link}</th></tr>
                <tr>
