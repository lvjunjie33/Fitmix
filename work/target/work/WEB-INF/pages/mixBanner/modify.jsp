    ...
    <%--<div class="uk-modal-dialog">--%>
        ...
        <div class="uk-form-row">
            <form action="/mix-banner/modify.json" method="post" class="uk-form login-form" isform>
                ...
                <div>
                    <select name="channel" class="uk-width-1-1 uk-form-large" data="${data.channel}">
                ...
                <c:if test="${empty data.typeValue}">
                    <div style="color: red;text-align: right;font-size: 20px" class="uk-form-row">专辑编号/单曲编号/电台编号/网页地址栏为空</div>
                </c:if>
...
<script type="text/html" id="SchemesUrlTemplate">
    <div class="uk-form-row">
        <input class="uk-width-1-1 uk-form-large" type="text" name="iosSchemesUrl" placeholder="IOS启动地址" value="${data.iosSchemesUrl}" notnull>
        <input class="uk-width-1-1 uk-form-large" type="text" name="androidSchemesUrl" placeholder="ANDROID启动地址" value="${data.androidSchemesUrl}" notnull>
    </div>
</script>
