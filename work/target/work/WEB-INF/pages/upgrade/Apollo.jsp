<html><head><%@ page contentType="text/html;charset=UTF-8" language="java" %><title>Apollo</title><style>
::-webkit-scrollbar {
width: 12px;
height: 12px;
}
...
</style></head><body style='background-color: #2C2D30;color:  #91939D;';><div>Apollo强制升级包</div></body></html>
