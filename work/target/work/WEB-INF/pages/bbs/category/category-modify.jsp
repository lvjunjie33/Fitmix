...
<div class="uk-container-center uk-body">
    <h2>添加分类信息</h2>
    <form action="/bbs/category/category-modify.json" method="post" class="uk-form uk-form-horizontal" channel-app-add-form>
            <input type="hidden" value="${category.id}" name="id">
            <div class="uk-form-row">
                <label class="uk-form-label">分类名称：</label>
                <div class="uk-form-controls"><input type="text" name="name" value="${category.name}" class="uk-form-large uk-width-9-10" notnull></div>
            </div>
