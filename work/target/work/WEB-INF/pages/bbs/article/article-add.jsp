...
<div class="uk-container-center uk-body">
    <h2>添加文章</h2>
    <form action="/bbs/article/article-add.json" method="post" class="uk-form uk-form-horizontal"  enctype="multipart/form-data" channel-app-add-form>

        <div class="uk-form-row">
            <label class="uk-form-label">标题：</label>
            <div class="uk-form-controls"><input type="text" name="title" class="uk-form-large uk-width-9-10" notnull></div>
        </div>
        ...
        <div class="uk-form-row">
            ...
            <div class="uk-form-controls"><input type="text" name="cornerMark" class="uk-form-large uk-width-9-10" notnull></div>
        </div>

        <div class="uk-form-row">
            <label class="uk-form-label">封面：</label>
            <div class="uk-form-controls"><input type="file" name="file" class="uk-form-large uk-width-9-10" notnull></div>
        </div>

        <div class="uk-form-row">
            <label class="uk-form-label">简介：</label>
            <div class="uk-form-controls">
                <textarea name="desc" class="uk-form-large uk-width-9-10" cols="5"></textarea>
            </div>
        </div>
...
(function(){
    ...
    editor.config.uploadImgUrl = '/bbs/article/upload-img.json';
