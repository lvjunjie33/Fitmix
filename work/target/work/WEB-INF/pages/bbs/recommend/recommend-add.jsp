...
<div class="uk-modal uk-open" id="BbsBannerAdd">
    <div class="uk-modal-dialog">
        ...
        <div class="uk-form-row">
            <form action="/bbs/recommend/recommend-add.json" enctype="multipart/form-data" method="post" class="uk-form login-form" isform>
                <div class="uk-form-row">
                ...
                <div class="uk-form-row">
                    <input name="cornerMark" class="uk-width-1-1 uk-form-large" placeholder="角标文字" />
                </div>
                <div class="uk-form-row">
