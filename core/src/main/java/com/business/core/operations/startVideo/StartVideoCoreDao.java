 ...
 */
@Repository
public class StartVideoCoreDao extends BaseMongoDaoSupport{
     ...
     */
    public StartVideo findStartVideo(Integer releaseStatus, Integer status, Long currentTime, String...fields) {
        ...
        return getRoutingMongoOps().findOne(query, StartVideo.class);
    }
}
