...
<link rel="stylesheet" href="/static/uikit/css/components/accordion.min.css">
    ...
    <link rel="stylesheet" href="/static/run-plan/css/run-plan-presentation.css">
   ...
   <script type="text/javascript" src="/static/run-plan/js/run-plan-presentation.js"></script>
